...
def create_app(config_name):
    ...
    app.add_url_rule('/org_last_commit', view_func=OrgLastCommits.as_view('org_last_commit'), methods=['GET'])
    ...
    app.add_url_rule('/user_worked_repository', view_func=UserWorkedRepository.as_view('user_worked_repository'), methods=['GET'])
    # team
